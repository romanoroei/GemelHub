...
const CONFIG = {
  ...
  PROVIDER_DISPLAY_NAMES: {
    ...
    'קרנות השתלמות למורים ולגננות - חברה מנהלת בע"מ': 'קרנות השתלמות למורים ולגננות',
    'רעות חברה לניהול קופות גמל בע"מ':            'רעות',
    // קופות ענפיות וסקטוריאליות — שם החברה המנהלת במקום הגוף השולט
    'החברה לניהול קופות התגמולים והפיצויים של עובדי בנק לאומי בע"מ': 'עובדי בנק לאומי',
    "חברת ב'ת למ'ד דל'ת בע\"מ":                  "ב'ת למ'ד דל'ת",
    'עגור חברה לניהול קופות גמל וקרנות השתלמות בע"מ': 'עגור',
    'קרנות השתלמות למורים תיכוניים, מורי סמינרים ומפקחים - חברה מנהלת בע"מ': 'קרנות השתלמות למורים תיכוניים',
    'החברה לניהול קרן השתלמות לאקדמאים במדעי החברה והרוח בע"מ': 'אקדמאים במדעי החברה והרוח',
    'החברה לניהול קרן ההשתלמות להנדסאים וטכנאים בע"מ': 'הנדסאים וטכנאים',
    'החברה לניהול קרן השתלמות למשפטנים בע"מ':      'משפטנים',
    'החברה לניהול קרן השתלמות לביוכימאים  ומקרוביולוגים בע"מ': 'ביוכימאים ומיקרוביולוגים',
    'החברה לניהול קרן השתלמות לשופטים בע"מ':       'שופטים',
    'ק.ה.ר - קרן השתלמות לרוקחים בע"מ':           'ק.ה.ר',
    'החברה המנהלת של מינהל קרן ההשתלמות לפקידים עובדי המנהל והשירותים בע"מ': 'מינהל',
    'שיבולת - חברה לניהול קופות גמל בע"מ':         'שיבולת',
    'ק.ל.ע. - חברה לניהול קרן השתלמות לעובדים סוציאליים בע"מ': 'ק.ל.ע',
    'החברה לניהול קרן ההשתלמות לעובדי המדינה בע"מ': 'עובדי המדינה',
    'עוצ"מ חברה לניהול קופות גמל והשתלמות בע"מ':  'עוצ"מ',
    'החברה המנהלת של רום קרן ההשתלמות לעובדי הרשויות המקומיות בע"מ': 'רום',
    'יהב אחים ואחיות - חברה לניהול קופות גמל בע"מ': 'יהב אחים ואחיות',
    'יחד רופאים - חברה לניהול קופות גמל בע"מ':     'יחד רופאים',
    'יהב - פ.ר.ח. - חברה לניהול קופות גמל בע"מ':  'יהב פ.ר.ח',
    'החברה המנהלת של קרן השתלמות של עובדי חברת החשמל לישראל בע"מ': 'עובדי חברת החשמל',
    'קרן ביטוח ופנסיה לפועלים חקלאים ובלתי מקצועיים בישראל אגודה שיתופית בע"מ': 'פועלים חקלאים',
    'קרן מקפת מרכז לפנסיה ותגמולים אגודה שיתופית בע"מ': 'מקפת מרכז',
    'קרן הביטוח והפנסיה של פועלי בנין ועבודות ציבוריות אגודה שיתופית בע"מ': 'פועלי בניין',
    'מבטחים מוסד לביטוח סוציאלי של העובדים בע"מ': 'מבטחים',
    'מחוג - מינהל גמל לעובדי חברת חשמל לישראל בע"מ': 'מחוג',
    'חברת הגמל לעובדי האוניברסיטה העברית בע"מ':   'עובדי האוניברסיטה העברית',
    'לאומי קמ"פ בע"מ':                             'לאומי קמ"פ',
    'חברה לניהול קופות גמל של העובדים בעיריית תל - אביב יפו בע"מ': 'עובדי עיריית תל אביב-יפו',
    'תגמולים של עובדים בעירית ת"א-יפו א.ש. בע"מ': 'תגמולים עובדי עיריית תל אביב-יפו',
    'עמ"י - חברה לניהול קופות גמל ענפיות בע"מ':   'עמ"י',
    'עוצ"מ - אגודה שיתופית לניהול קופות גמל בע"מ': 'עוצ"מ',
    'מחר - חברה לניהול קופות גמל בע"מ':            'מחר',
    'קופת תגמולים של עובדי אל על נתיבי אוויר לישראל בע"מ אגודה שיתופית': 'עובדי אל על',
    'סלייס גמל בע"מ ':                              'סלייס',
    'גלובלנט ניהול קופות גמל בע"מ':                 'גלובלנט',
    'קו הבריאות חברה לניהול קופות גמל בע"מ':       'קו הבריאות',
    'קופת"ג של עובדי עירית חיפה':                  'עובדי עיריית חיפה',
    'עו"ס - חברה לניהול קופות גמל בע"מ':           'עו"ס',
    'גל -ניהול קופות גמל לעובדי הוראה בע"מ':       'גל',
    'קופת תגמולים של עובדי התעשיה האוירית לישראל בע"מ': 'עובדי התעשייה האווירית',
    "ארם גמולים - חברה לניהול קופות גמל בע''מ":   'ארם גמולים',
    'הנדסאים וטכנאים - חברה לניהול קופות גמל בע"מ': 'הנדסאים וטכנאים',
    'אקטיון בע"מ':                                  'אקטיון',
  ...
  INVESTMENT_TRACKS: [
    ...
    { id: 'polisa_kaklali',
      ...
      fundIds: ['18013'],
      fundNameIncludes: ['כללי'],
      fundNameExcludes: ['פאסיבי',' 2','BlackRock','fidelity','State Street','Apollo','שריעה','למקבלי','קצבה'] },

    { id: 'polisa_maniот',
      label: 'מניות',
      fundNameIncludes: ['מניות'],
      fundNameExcludes: ['BlackRock','fidelity','State Street','Apollo','סחיר','עוקב','למקבלי','S&P','s&p','אג"ח','25%','ממשלות','ממשלת','קצבה'] },
    ...
    { id: 'polisa_global_maniот',
      label: 'מניות חו"ל',
      group: 'global_management',
      groupLabel: 'ניהול עולמי',
      managerTokens: ['BlackRock','fidelity','State Street','Apollo'],
      fundNameIncludes: ['מניות'],
      fundNameExcludes: ['אג"ח','25%'] },

    { id: 'polisa_global_kaklali',
      label: 'כללי חו"ל',
      group: 'global_management',
      groupLabel: 'ניהול עולמי',
      managerTokens: ['BlackRock','fidelity','State Street','Apollo'],
    ...
    { id: 'polisa_global_ashrai_agach',
      label: 'אשראי ואג"ח',
      group: 'global_management',
      groupLabel: 'ניהול עולמי',
      managerTokens: ['BlackRock','fidelity','State Street','Apollo'],
      fundNameIncludes: ['אשראי ואג"ח', 'אשראי אג"ח'],
      fundNameExcludes: ['מניות','25%'] },
    ...
    { id: 'polisa_ashrai_agach',
      ...
      fundNameExcludes: ['BlackRock','fidelity','State Street','Apollo','מניות'] },
...
function getProviderDisplayName(controllingCorp, managingCorp) {
  ...
  for (const src of [controllingCorp, managingCorp]) {
    ...
    for (const allowed of CONFIG.ALLOWED_PROVIDERS) {
      // Match a provider as a complete name/token. Plain includes() made "מור"
      // match words such as "מורים", and consequently mislabeled sector funds.
      const escaped = allowed.replace(/[.*+?^${}()|[\]\\]/g, '\\$&');
      const providerToken = new RegExp(`(^|[^\\p{L}\\p{N}])${escaped}($|[^\\p{L}\\p{N}])`, 'u');
      if (providerToken.test(src)) return allowed;
    }
  }
